...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Essentials
\name{Christopher L. Campell}{}
\address{3600 Courtland Drive, Durham NC, 27707}
\mobile{(919) 724-0993} 
%%% Social
\email{campellcl@gmail.com}
\homepage{}
\github{ccampell}
\linkedin{campellcl}
%%% Optionals
\position{Software Engineer{\enskip\cdotp\enskip}Data Miner{\enskip\cdotp\enskip}Machine Learning Practitioner}
